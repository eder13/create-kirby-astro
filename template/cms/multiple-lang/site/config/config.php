...
require_once(__DIR__ . '/../helpers/translation_keys.php');
...
return [
    ...
    'routes' => [
        ...
        [
            'pattern' => 'messages',
            'action' => function () {
                return getTranslationKeysObject();
            },
            'method' => "GET"
        ],
        [
            ...
            'action'  => function() {
                ...
                $content = snippet('sitemap-index', compact('pages', 'ignore'), true);
                return new Kirby\Cms\Response($content, 'application/xml');
            }
        ],
        [
            'pattern' => 'sitemap-([a-z]{2})\.xml',
            'action'  => function ($lang) {
                $pages = site()->pages()->index();
                $ignore = kirby()->option('sitemap.ignore', ['error']);
                $content = snippet('sitemap', compact('pages', 'ignore', 'lang'), true);
                return new Kirby\Cms\Response($content, 'application/xml');
            }
        ],
        [
            ...
            'action'  => function() {
                ...
                $content = "User-agent: *\nDisallow: /error\n{{disallowErrorLanguagePages}}Disallow: /cms/\nDisallow: /frontend/\nDisallow: /tmp/\nDisallow: /_astro/\nAllow: /\n\nSitemap: " . $base . "/sitemap.xml\n";
